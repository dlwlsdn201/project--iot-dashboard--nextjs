...
export function EnergySourceTrendWidget() {
  return (
    <Card title="7-Day Trend — Energy Source" className="h-full">
      <ResponsiveContainer width="100%" height={200}>
        <BarChart data={energySourceTrendData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
          ...
          <Bar dataKey="electricity" name="Electricity" stackId="a" fill={SOURCE_COLORS.electricity} isAnimationActive={false} radius={[0, 0, 0, 0]} />
